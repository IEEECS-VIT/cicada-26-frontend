 ...
 *
 * Self-contained: Shadow DOM, no globals, no dependencies. Sizes to its own
 * box (container units), so give the element a width AND a height.
 * Hover moves the camera, click/hold dives toward Gargantua.
 */
(() => {
  const CAMS = 400;
  const CSS = `:host{display:block;position:relative;width:100%;height:100%;container-type:size;isolation:isolate;overflow:hidden}
...
:host {  background: linear-gradient(-45deg, #080808, #0a0a0a, #080808), #080808;
  overflow: hidden;
...
.module {
  ...
  --width: 10;
  --depth: 15;
  transform: translate3d(0cqmin, 0cqmin, 0cqmin);
  transform-origin: left center;
  height: calc(var(--height) * 1cqmin);
  width: calc(var(--width) * 1cqmin);
  position: absolute;
  bottom: 0;
}
.module .side {
...
.type-1 .side:nth-of-type(1) {
  ...
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin));
...
.type-1 .side:nth-of-type(3) {
  width: calc(var(--depth) * 1cqmin - 1.5cqmin);
  transform: translate(-50%, -50%) rotateY(90deg) translate3d(0.75cqmin, 0, calc(var(--width) * 0.5cqmin));
...
.type-1 .side:nth-of-type(5) {
  height: calc(var(--depth) * 1cqmin);
  transform: translate(-50%, -50%) rotateX(90deg) translate3d(0, 0, calc(var(--height) * 0.5cqmin));
...
.type-1 .side:nth-of-type(7) {
  height: calc(var(--height) * 1cqmin);
  width: calc(var(--width) * 1cqmin / 4.625 );
  transform: translate3d(63%, -50%, calc(var(--depth) * 0.5cqmin)) rotateY(225deg);
...
.type-1 .side:nth-of-type(8) {
  height: calc(var(--height) * 1cqmin);
  width: calc(var(--width) * 1cqmin / 4.625 );
  transform: translate3d(-260%, -50%, calc(var(--depth) * 0.5cqmin)) rotateY(-44deg);
  transform-origin: right center;
...
.type-2 .side:nth-of-type(1) {
  ...
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin)) translate3d(0, calc(var(--width) / 4 * -1cqmin), 0);
...
.type-2 .side:nth-of-type(2) {
  height: calc(100% / 1.5);
  transform: translate3d(-50%, -25%, calc(var(--depth) * -0.5cqmin)) rotateY(180deg);
  background-color: var(--luz-25);
  clip-path: polygon(0% 0%, 0% 100%, 10% 100%, 10% 10%, 90% 10%, 90% 90%, 10% 90%, 10% 100%, 100% 100%, 100% 0%);
}
.type-2 .side:nth-of-type(3) {
  width: calc(var(--depth) * 1cqmin);
  clip-path: polygon(74% 0, 100% 33%, 100% 100%, 26% 100%, 0 67%, 0 0);
  transform: translate(-50%, -50%) rotateY(90deg) translate3d(0cqmin, 0, calc(var(--width) * 0.5cqmin));
  background-color: var(--luz-40);
}
...
.type-2 .side:nth-of-type(5) {
  height: calc(var(--depth) * 1cqmin - 3.9cqmin);
  transform: translate(-50%, -50%) rotateX(90deg) translate3d(0, 1.9cqmin, calc(var(--height) * 0.5cqmin));
...
.type-2 .side:nth-of-type(6) {
  height: calc(var(--depth) * 1cqmin - 3.9cqmin);
  transform: translate(-50%, -50%) rotateX(-90deg) translate3d(0cqmin, 1.9cqmin, calc(var(--height) * 0.5cqmin));
...
.type-2 .side:nth-of-type(7) {
  ...
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin)) translate3d(0, 5.7cqmin, 0cqmin) rotateX(-38.5deg);
  height: calc(100% - var(--width) * 0.875cqmin);
...
.type-2 .side:nth-of-type(8) {
  transform-origin: center top;
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin)) translate3d(0, -4.3cqmin, -11.1cqmin) rotateX(-38.5deg);
...
.type-3 > .side:nth-of-type(2) {
  clip-path: none;
  transform: translate3d(-50%, -50%, calc(var(--depth) * -0.5cqmin)) rotateY(0deg) rotateZ(180deg);
  background-color: var(--luz-35);
}
...
.type-3 .cuboid.hole {
  transform: translate3d(1cqmin, -9.1cqmin, -2.5cqmin) rotateX(-90deg);
}
...
.type-2.type-3 {
  ...
  --width: 3;
  --depth: 5;
  transform: translate3d(4.91cqmin, -9.975cqmin, 7cqmin) rotate(90deg);
}
.type-2.type-3 > .side:nth-of-type(1) {
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin)) translate3d(0, calc(var(--width) / 1.9 * -1cqmin), 0);
...
.type-2.type-3 > .side:nth-of-type(5) {
  height: 100%;
  transform: translate(-50%, -50%) rotateX(0deg) rotateY(0deg) translate3d(0, 0, calc(var(--height) * -0.25cqmin));
  background-color: var(--luz-25);
}
.type-2.type-3 > .side:nth-of-type(6) {
  height: calc(var(--depth) * 0.75cqmin );
  transform: translate(-50%, -50%) rotateX(-90deg) translate3d(0cqmin, 0.65cqmin, calc(var(--height) * 0.5cqmin));
  background-color: var(--luz-60);
}
.type-2.type-3 > .side:nth-of-type(7) {
  height: calc(100% - var( --width) * 2.15cqmin);
  transform-origin: center top;
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin)) translate3d(0, 3.5cqmin, 0cqmin) rotateX(-22deg);
...
.type-2.type-3 > .side:nth-of-type(8) {
  height: calc(var(--depth) * 1cqmin );
  transform: translate(-50%, -50%) rotateX(-90deg) translate3d(0cqmin, -2.5cqmin, calc(var(--height) * -0.25cqmin));
  background-color: var(--luz-40);
}
...
.mod-3 .type-1.type-3 .window {
  transform: rotateX(-90deg) translate3d(1.5cqmin, -6.5cqmin, -8cqmin);
}
...
.cuboid .side:nth-of-type(2) {
  transform: translate3d(-50%, -50%, calc(var(--depth) * -0.5cqmin)) rotateY(180deg);
  background-color: var(--luz-25);
}
.cuboid .side:nth-of-type(3) {
  width: calc(var(--depth) * 1cqmin);
  transform: translate(-50%, -50%) rotateY(90deg) translate3d(0, 0, calc(var(--width) * 0.5cqmin));
  background-color: var(--luz-40);
}
...
.cylinder .side:nth-of-type(3) {
  width: calc(var(--depth) * 1cqmin);
  height: calc(calc(calc(var(--width) * 41.17) / 100) * 1cqmin);
  transform: translate(-50%, -50%) rotateY(90deg) translate3d(0, 0, calc(var(--width) * 0.5cqmin));
...
.cylinder .side:nth-of-type(5) {
  height: calc(var(--depth) * 1cqmin);
  width: calc(calc(calc(var(--width) * 41.17) / 100) * 1cqmin);
  transform: translate(-50%, -50%) rotateX(90deg) translate3d(0, 0, calc(var(--height) * 0.5cqmin));
  background-color: var(--luz-80);
}
...
.cylinder .side:nth-of-type(7) {
  height: calc(var(--depth) * 1cqmin);
  width: calc(calc(calc(var(--width) * 41.17) / 100) * 1cqmin);
  transform: translate(-50%, -50%) rotateX(-90deg) rotateY(45deg) translate3d(0, 0, calc(var(--height) * 0.5cqmin));
  background-color: var(--luz-40);
}
...
.cylinder .side:nth-of-type(9) {
  height: calc(var(--depth) * 1cqmin);
  width: calc(calc(calc(var(--width) * 41.17) / 100) * 1cqmin);
  transform: translate(-50%, -50%) rotateX(-90deg) rotateY(135deg) translate3d(0, 0, calc(var(--height) * 0.5cqmin));
  background-color: var(--luz-70);
}
...
.cylinder + .cylinder.port {
  --depth: 5;
  transform: rotateX(-90deg) rotateY(180deg) translateZ(-0.5cqmin);
}
...
.hatch {
  ...
  height: 100%;
  position: absolute;
  transform: translateZ(-3cqmin) translateX(0.05cqmin);
  border-radius: 100%;
}
.hatch span {
  width: 100%;
...
.hatch span:before {
  content: "";
  border: 0.5cqmin solid #fff0;
  border-top: 0.85cqmin solid var(--luz-20);
  position: absolute;
  transform: rotateX(-45deg) translate3d(0.95cqmin, 0cqmin, 0.35cqmin);
  transform-style: preserve-3d;
  transform-origin: center top;
  border-radius: 2px;
  width: 0.25cqmin;
...
.hatch span:after {
  width: 0.75cqmin;
  border-right: 0.25cqmin solid var(--luz-50);
  border-left: 0.25cqmin solid var(--luz-50);
  height: 0.35cqmin;
  position: absolute;
  content: "";
  transform: rotateX(-90deg) translate3d(0cqmin, -0.35cqmin, 0.2cqmin);
  top: -0.15cqmin;
  left: 1.25cqmin;
  box-sizing: border-box;
}
...
.cuboid.hole {
  ...
  --width: 8;
  --depth: 4;
  transform: translate3d(1cqmin, -1cqmin, -5.5cqmin);
  position: absolute;
  bottom: 0;
}
...
.type-1.type-3 .cuboid.hole > span {
  ...
  height: 100%;
  position: absolute;
  transform: rotateX(90deg) translate3d(0cqmin, 2cqmin, -1.5cqmin);
}
...
.type-1.type-3 .cuboid.hole > span:before {
  ...
  height: 100%;
  position: absolute;
  transform: rotateX(-90deg) translate3d(0cqmin, 1.2cqmin, -4.01cqmin);
}
...
.type-1.type-3 .cuboid.hole > span:after {
  ...
  height: 100%;
  position: absolute;
  transform: rotateX(0deg) translate3d(0cqmin, 0, 2.8cqmin);
}
...
.nozzle div, .nozzle:before, .nozzle:after {
  ...
  box-shadow: 0 0 0.5cqmin 0.5cqmin #d7ebfb;
  border-color: #dcf4ff;
  opacity: 0;
  transition: all 0.5s ease 0s;
  transform: translate3d(0.25cqmin, -1.25cqmin, 5cqmin) rotateX(90deg) rotateY(210deg);
  border-radius: 50%;
  position: absolute;
}
.nozzle:before {
  content: "";
  transform: translate3d(0.25cqmin, -1.25cqmin, 5cqmin) rotateX(90deg) rotateY(90deg);
  position: absolute;
}
.nozzle:after {
  content: "";
  transform: translate3d(0.25cqmin, -1.25cqmin, 5cqmin) rotateX(90deg) rotateY(320deg);
}
...
.radius .group {
  padding-left: 3.25cqmin;
  box-sizing: border-box;
  transform: rotate(270deg);
}
.radius .cylinder {
  transform: rotateX(90deg) translate3d(0, 0, 19.5cqmin) rotateZ(180deg);
  --height: 3;
  --width: 3;
  --depth: 44;
  /*** Ranger Ports ***/
...
.radius .cylinder + .cylinder {
  ...
  --width: 5;
  --depth: 7;
  transform: rotateX(90deg) rotateZ(180deg) translate3d(1cqmin, 0cqmin, 0.5cqmin);
}
.radius .cylinder:nth-child(1) .hatch {
  transform: translateZ(22.5cqmin) translateX(0.05cqmin) rotateX(180deg);
}
.radius .cylinder:nth-child(3) {
  transform: rotateX(90deg) rotateZ(180deg) translate3d(1cqmin, 0cqmin, 10cqmin);
}
.radius .cylinder:nth-child(4) {
  transform: rotateX(90deg) rotateZ(180deg) translate3d(1cqmin, 0cqmin, 19.5cqmin);
}
.radius .cylinder:nth-child(5) {
  transform: rotateX(90deg) rotateZ(180deg) translate3d(1cqmin, 0cqmin, 35cqmin);
}
.radius .cylinder:nth-child(6) {
  transform: rotateX(90deg) rotateZ(180deg) translate3d(1cqmin, 0cqmin, 27.25cqmin);
  --depth: 4;
}
.radius .cylinder:nth-child(7) {
  transform: rotateX(0deg) rotateY(90deg) rotateZ(0deg) translate3d(0cqmin, -28.25cqmin, 0cqmin);
  --height: 3;
  --width: 3;
  --depth: 18;
}
.radius .cylinder:nth-child(7) .hatch {
  transform: translateZ(9.5cqmin) translateX(0.05cqmin) rotateX(180deg);
}
.radius .cylinder:nth-child(7) .hatch + .hatch {
  transform: translateZ(-9.5cqmin) translateX(0.05cqmin);
}
.radius .cylinder:nth-child(8) {
  transform: rotateX(0deg) rotateY(90deg) rotateZ(0deg) translate3d(0cqmin, -27.25cqmin, 4.5cqmin);
  --depth: 4;
}
.radius .cylinder:nth-child(9) {
  transform: rotateX(0deg) rotateY(90deg) rotateZ(0deg) translate3d(0cqmin, -27.25cqmin, -6.5cqmin);
  --depth: 4;
}
.radius .cylinder:nth-child(10) {
  transform: rotateX(0deg) rotateY(0deg) rotateZ(0deg) translate3d(0cqmin, -28.25cqmin, -3.75cqmin);
  --height: 3;
  --width: 3;
  --depth: 27.5;
}
.radius .cylinder:nth-child(10) .hatch {
  transform: translateZ(14.15cqmin) translateX(0.05cqmin) rotateX(180deg);
}
.radius .cylinder:nth-child(10) .hatch + .hatch {
  transform: translateZ(-14.15cqmin) translateX(0.05cqmin);
}
.radius .cylinder:nth-child(11) {
  transform: rotateX(0deg) rotateY(0deg) rotateZ(0deg) translate3d(-1cqmin, -27.25cqmin, 6.5cqmin);
  --depth: 4;
}
.radius .cylinder:nth-child(12) {
  transform: rotateX(0deg) rotateY(0deg) rotateZ(0deg) translate3d(-1cqmin, -27.25cqmin, -10cqmin);
  --depth: 12;
}
.radius .cylinder:nth-child(17) .hatch {
  transform: translateZ(0.85cqmin) translateX(0.05cqmin) rotateX(180deg) scale3d(0.75, 0.75, 0.75);
  width: 115%;
  height: 115%;
  top: -5%;
  left: -7.5%;
...
.radius .cylinder ~ .cuboid.chain {
  transform: translate3d(0.25cqmin, -21.9cqmin, 2cqmin) rotateY(0) rotateX(-190deg);
  --width: 2.4;
  --height: 2.4;
  --depth: 5;
}
...
.radius .cylinder ~ .cuboid.chain + .cylinder {
  --depth: 1;
  transform: translate3d(0.25cqmin, -34.95cqmin, 6.85cqmin) rotateX(-15deg);
  --width: 2.4;
  --height: 2.4;
}
.radius .cylinder ~ .cuboid.chain + .cylinder + .cylinder {
  --depth: 1;
  transform: translate3d(0.25cqmin, -22.3cqmin, 6.85cqmin) rotateX(15deg);
  --width: 2.4;
  --height: 2.4;
}
.radius .cylinder + .cuboid.chain + .cuboid.chain {
  transform: translate3d(0.25cqmin, -35.25cqmin, 2cqmin) rotateY(0deg) rotateX(10deg);
}
.radius .cylinder + .cuboid.chain + .cuboid.chain + .cuboid.chain {
  transform: translate3d(0.25cqmin, -21.76cqmin, 5.15cqmin) rotateY(0deg) rotatex(-165deg);
  --depth: 2.5;
}
...
.radius .cylinder + .cuboid.chain + .cuboid.chain + .cuboid.chain + .cuboid.chain {
  transform: translate3d(0.25cqmin, -35.4cqmin, 5.15cqmin) rotateY(0deg) rotatex(-15deg);
  --depth: 2.5;
}
...
.group.mod-12 .module > .side:nth-child(2):after {
  ...
  left: 37%;
  top: 29%;
  border-right: 1.1cqmin solid var(--luz-25);
  border-left: 1.1cqmin solid var(--luz-25);
}
...
.group.mod-7 .module > .side:nth-child(2):after,
.group.mod-11 .module > .side:nth-child(2):after {
  box-shadow: 6cqmin 9.25cqmin 0 var(--luz-10), 6cqmin 10cqmin 0 var(--luz-10), 2.5cqmin 9.25cqmin 0 var(--luz-10), 2.5cqmin 10cqmin 0 var(--luz-10), 0.5cqmin 9.25cqmin 0 var(--luz-10), 0.5cqmin 10cqmin 0 var(--luz-10), -1.5cqmin 9.25cqmin 0 var(--luz-10), -1.5cqmin 10cqmin 0 var(--luz-10), -3.5cqmin 9.25cqmin 0 var(--luz-10), -3.5cqmin 10cqmin 0 var(--luz-10), -5.5cqmin 9.25cqmin 0 var(--luz-10), -5.5cqmin 10cqmin 0 var(--luz-10);
}
...
.group.mod-9 .module > .side:nth-child(5):after {
  ...
  left: 14%;
  top: 66%;
  box-shadow: 1.45cqmin 0 0 0 var(--luz-25), 2.8cqmin 0 0 0 var(--luz-15), 4.1cqmin 0 0 0 var(--luz-20), 5.45cqmin 0 0 0 var(--luz-40), 6.8cqmin 0 0 0 var(--luz-25);
}
...
.window {
  ...
  bottom: 0;
  position: absolute;
  transform: translate3d(1.4cqmin, -13cqmin, -0.3cqmin);
  height: calc(var(--height) * 1cqmin);
  width: calc(var(--width) * 1cqmin);
  /*** end .side ***/
}
...
.window .side:nth-of-type(1) {
  transform: translate3d(-50%, -50%, calc(var(--depth) * 0.5cqmin)) rotateX(-40deg);
...
.window .side:nth-of-type(2) {
  transform: translate3d(-50%, -50%, calc(var(--depth) * -0.5cqmin)) rotateY(180deg) rotateX(-40deg);
  background: var(--luz-85) !important;
  transform-origin: top center;
}
.window .side:nth-of-type(3) {
  width: calc(var(--depth) * 1cqmin);
  transform: translate(-50%, -50%) rotateY(90deg) translate3d(0, 0, calc(var(--width) * 0.5cqmin)) rotateX(-40deg);
  background: var(--luz-60);
  transform-origin: top center;
}
...
.window .side:nth-of-type(5) {
  height: calc(var(--depth) * 0.425cqmin);
  transform: translate(-50%, -50%) rotateX(-90deg) translate3d(0, 0, calc(var(--height) * 0.25cqmin));
  background: var(--luz-75) !important;
  clip-path: none !important;
  width: 66%;
  height: calc(var(--depth) * 0.775cqmin);
  transform: translate(-50%, -50%) rotateX(-90deg) translate3d(0, 0, calc(var(--height) * -0.25cqmin));
...
.group.mod-11 .module .window {
  transform: translate3d(1.4cqmin, -13cqmin, -4.25cqmin);
}
...
.group.mod-12 .module .side:nth-child(6) {
  ...
  background-color: var(--luz-35);
  background-position: -1.15cqmin 0, 0 0, 0.5cqmin 0.05cqmin;
...
.group.mod-11 .type-1 .side:nth-of-type(6) {
  background: repeating-linear-gradient(0deg, #0b0b0b 0.25cqmin, #fff0 0.75cqmin), repeating-linear-gradient(90deg, #0b0b0b 0.3cqmin, #fff0 0.75cqmin), var(--luz-05);
...
.cam:active ~ .blackhole .gargantua {
  transform: rotate(-5deg) scale3d(0.175, 0.175, 0.175) translate3d(-10cqw, -15cqh, -250cqmin);
...
.gargantua {
  ...
  align-items: center;
  position: relative;
  transform: rotate(-5deg) scale3d(0.2, 0.2, 0.2) translate3d(-10cqw, -15cqh, -250cqmin);
  transition: all 1.45s ease 0.25s;
}
...
.bot-photon-ring {
  width: 18cqmax;
  height: 10cqmax;
  border-radius: 1cqmax 1cqmax 20cqmax 20cqmax;
  box-shadow: 0 0 5px 2px var(--black);
  top: 28.5cqmax;
  border: 2px solid var(--white);
  border-top: 0;
  background: var(--black);
  margin-left: 0.75cqmax;
...
.image-disk-lines {
  ...
  height: 22cqmax;
  border-radius: 100%;
  background: radial-gradient(circle at 50% 50%, transparent, transparent 9.25cqmax, var(--yellow) 9.5cqmax, var(--yellow) 9.55cqmax, var(--white) 9.55cqmax, var(--white) 9.95cqmax, var(--yellow) 9.95cqmax, var(--yellow) 10.05cqmax, var(--white) 10.05cqmax, var(--white) 10.35cqmax, var(--yellow) 10.35cqmax, var(--yellow) 10.42cqmax, var(--white) 10.42cqmax, var(--white) 10.75cqmax, var(--yellow) 10.75cqmax, var(--yellow) 10.79cqmax, var(--white) 10.79cqmax, var(--white) 10.95cqmax, red 22cqmax);
}

.accretion-disk {
  background: radial-gradient(ellipse at 49.5% 40%, transparent, transparent 11.15cqmax, var(--white) 11.15cqmax, var(--yellow) 11.15cqmax, var(--yellow) 11.2cqmax, var(--white) 11.2cqmax, var(--white) 12.5cqmax, var(--yellow) 12.5cqmax, var(--yellow) 12.65cqmax, var(--white) 12.65cqmax, var(--white) 13.5cqmax, var(--yellow) 13.5cqmax, var(--yellow) 13.55cqmax, var(--white) 13.55cqmax, var(--white) 14.45cqmax, var(--yellow) 14.45cqmax, var(--yellow) 14.55cqmax, var(--white) 14.55cqmax, var(--white) 15.5cqmax, var(--yellow) 15.5cqmax, var(--yellow) 15.65cqmax, var(--white) 15.65cqmax, var(--white) 16.5cqmax, var(--yellow) 16.5cqmax, var(--yellow) 16.65cqmax, var(--white) 16.65cqmax, var(--white) 17.6cqmax, var(--yellow) 17.6cqmax, var(--yellow) 17.65cqmax, var(--white) 17.65cqmax, var(--white) 18.25cqmax, var(--yellow) 18.25cqmax, var(--yellow) 18.35cqmax, var(--white) 18.35cqmax, var(--white) 19.15cqmax, var(--yellow) 19.15cqmax, var(--yellow) 19.35cqmax, var(--white) 19.35cqmax, var(--white) 19.95cqmax, var(--yellow) 19.95cqmax, var(--yellow) 20.05cqmax, var(--white) 20.05cqmax, var(--white) 20.75cqmax, var(--yellow) 20.75cqmax, var(--yellow) 20.85cqmax, var(--white) 20.85cqmax, var(--white) 21.5cqmax, var(--yellow) 21.5cqmax, var(--yellow) 21.55cqmax, var(--white) 21.55cqmax, var(--white) 22.5cqmax, var(--yellow) 22.5cqmax, var(--yellow) 22.65cqmax, var(--white) 22.65cqmax, var(--white) 23.45cqmax, var(--yellow) 23.45cqmax, var(--yellow) 23.52cqmax, var(--white) 23.55cqmax), radial-gradient(ellipse at 49.5% 37%, var(--black), var(--black) 9.25cqmax, var(--white) 9.5cqmax, var(--white));
  width: 54cqmax;
  height: 6cqmax;
  border-radius: 100%;
  top: 28.5cqmax;
...
.top-photon-ring {
  width: 17cqmax;
  height: 9cqmax;
  border-radius: 20cqmax 20cqmax 1cqmax 1cqmax;
  background: var(--black);
  top: 21.5cqmax;
...
.top-photon-ring:after {
  ...
  <div class="endurance">
    <div class="modules">
      <div class="group mod-1">
        <div class="module type-1">
          ...
          <div class="cuboid hole">
            <div class="side"></div>
            <div class="side"></div>
            <div class="side"></div>
            <div class="side"></div>
            <div class="side"></div>
            <div class="side"></div><span></span>
          </div>
        </div>
      </div>
      <div class="group mod-2">
        <div class="module type-2">
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
          ...
          <div class="cuboid hole">
            ...
            <div class="side"></div>
            <div class="side"></div>
            <div class="nozzle"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span>
              <div></div>
            </div>
            <div class="nozzle"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span>
              <div></div>
      ...
      <div class="group mod-3">
        <div class="module type-1 type-3">
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
        ...
        <div class="module type-2 type-3">
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
    ...
    <div class="cylinders">
      ...
      <div class="group cyl-3">
        ...
        <div class="cylinder port">
          ...
          <div class="side"></div>
          <div class="side"></div>
          <div class="hatch"><span></span><span></span><span></span></div>
        </div>
      </div>
      <div class="group cyl-4">
        <div class="cylinder">
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
    ...
    <div class="chains">
      <div class="group cha-1">
        <div class="cuboid chain">
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
          <div class="side"></div>
...
<div class="blackhole">
  ...
  let sheet;
  class EnduranceShip extends HTMLElement {
    connectedCallback() {
      if (this.shadowRoot) return;
      const root = this.attachShadow({ mode: 'open' });
      if (sheet === undefined) {
        try { sheet = new CSSStyleSheet(); sheet.replaceSync(CSS); } catch { sheet = null; }
      }
      if (sheet) root.adoptedStyleSheets = [sheet];
      // style goes last: .cam rules are :nth-child based
      root.innerHTML = '<div class="cam"></div>'.repeat(CAMS) + HTML +
        (sheet ? '' : '<style>' + CSS + '</style>');
    }
  }
  if (!customElements.get('endurance-ship')) customElements.define('endurance-ship', EnduranceShip);
})();
