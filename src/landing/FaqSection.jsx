...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "The number of submissions allowed may differ between challenges. The submission limit for each challenge will be specified along with the challenge itself on the website.",
  },
  {
    id: "004",
    question: "HOW DO HINTS WORK?",
    answer:
      "Participants cannot request hints individually. Standardised hints will be released to all participants simultaneously at regular intervals throughout each round.",
  },
  {
    id: "005",
    ...
    list: [
      ...
      "The event concludes by 6:00 PM.",
    ],
  },
  {
    id: "006",
    ...
    list: [
      ...
      "Important announcements may also be communicated through Discord during the event.",
    ],
  },
  {
    id: "007",
  ...
  },
  {
    ...
    list: [
      ...
      "However, sharing answers, flags, or challenge solutions with other competing teams is prohibited.",
    ],
  },
  {
    id: "009",
